...
module.exports = {
 ...
 OB_NAME: process.env.ZA_DEP_NAME === undefined ? 'deploy' : process.env.ZA_DEP_NAME,
 ...
 OB_REPLY: process.env.ZA_DEP_REPLY === undefined ? '```https://bit.ly/deploy-ZaraMwol```' : process.env.ZA_DEP_REPLY,
